...
These two maps are Choropleth maps of Africa showing total fertility rates in each country. Fertility rates (from 1 to 8) are represented by a color gradient ranging from yellow for low rates (around 2) to red for high rates (above 6). The first map dates back to 1960 and the second one to 2018. 
